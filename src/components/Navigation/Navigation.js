    ...
    <nav id="home" className="container__nav">
      <div className="container__nav--left-side">
        ...
        <div className="container__nav--buttons">
          <a href={links ? "/" : "#home"} className="container__nav--btn">
            Home
          </a>
          <a href={links ? "/" : "#timeline"} className="container__nav--btn">
            Timeline
          </a>
          <a href={links ? "/" : "#projects"} className="container__nav--btn">
            Projects
          </a>
          <a href={links ? "/" : "#skills"} className="container__nav--btn">
            Skills
          </a>
          <a
            href={links ? "/" : "#certificates"}
            className="container__nav--btn"
          >
            Certificates
          </a>
        </div>
